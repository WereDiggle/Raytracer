...
noise_1 = gr.noise(20, 20)
noise_2 = gr.noise(20, 20)
noise_3 = gr.noise(20, 20)
noise_4 = gr.noise(5, 5)
noise_5 = gr.noise(20, 20)
noise_6 = gr.noise(20, 20)
noise_7 = gr.noise(20, 20)
noise_8 = gr.noise(20, 20)
noise_9 = gr.noise(20, 20)
...
bottom_plane:set_bitmap(noise_2)
...
right_plane:set_bitmap(noise_3)
...
back_sphere:set_bitmap(noise_5)
...
gr.render(scene_root, 'noise_hi_res.png', 1920, 1920,
