...
gr.render(scene_root, 'models_1.png', 256, 256,
	  {-50, -50, 80}, {0, -45, 0}, {0, 1, 0}, 90,
	  ambientLight, lights)

gr.render(scene_root, 'models_2.png', 256, 256,
	  {-50, 50, 80}, {0, -45, 0}, {0, 1, 0}, 90,
	  ambientLight, lights)

gr.render(scene_root, 'models_3.png', 256, 256,
	  {50, 50, 80}, {0, -45, 0}, {0, 1, 0}, 90,
	  ambientLight, lights)

gr.render(scene_root, 'models_4.png', 256, 256,
	  {-50, 50, -80}, {0, -45, 0}, {0, 1, 0}, 90,
	  ambientLight, lights)

gr.render(scene_root, 'models_5.png', 256, 256,
	  {50, 50, -80}, {0, -45, 0}, {0, 1, 0}, 90,
	  ambientLight, lights)