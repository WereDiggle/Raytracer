...
gr.render(scene_root, 'bump_maps_1_hi_res.png', 1920, 1080,
	  {0, 0, 99}, {0, -50, -100}, {0, 1, 0}, 90,
	  ambientLight, lights)

lights = {white_light_2}

gr.render(scene_root, 'bump_maps_2_hi_res.png', 1920, 1080,
	  {0, 0, 99}, {0, -50, -100}, {0, 1, 0}, 90,
	  ambientLight, lights)

lights = {white_light_3}

gr.render(scene_root, 'bump_maps_3_hi_res.png', 1920, 1080,
	  {0, 0, 99}, {0, -50, -100}, {0, 1, 0}, 90,
	  ambientLight, lights)
