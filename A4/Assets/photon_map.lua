...
--front_sphere:set_transparency(1, 1)
...
white_light_center = gr.light({0, 0, 0}, {2, 2, 2}, {1, 0, 0})

ambientLight = {0.0, 0.0, 0.0}

lights = {white_light_center}

gr.render(scene_root, 'photon_map_black_spots_1.png', 256, 256,
	  {0, 0, 90}, {0, 0, -100}, {0, 1, 0}, 100,
	  ambientLight, lights)